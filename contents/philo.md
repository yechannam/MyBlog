...
이 부분에서 에러 처리에 대한 고민을 좀 했는데,

malloc의 null가드를 해야할까?부터 시작해
에러 처리를 어느 정도까지 해야할까? (printf같은 함수들도 모두 해야하나?)
등에 대해 생각했다.

결론은 내가 할 수 있는 부분들은 **관리하자** 였다.
...
예를들어, 포크를 2개 다 잡고 바로 식사를 할 수 있을 때 포크를 잡도록 처리한 분들이 있다.
이런 경우는 모두 **정의되지 않은 행동** 으로 잘못되었다는 주장이다.
